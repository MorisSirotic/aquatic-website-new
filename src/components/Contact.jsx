      ...
      <div className="flex w-full justify-between  flex-wrap  p-9  bg-slate-200">
        ...
        <div className="w-52 border-l-8 border-l-slate-400 border">
          <div className="flex flex-col ml-2">
            ...
            <a className="hover:text-blue-700" href="tel:+385 92 166 0453">+385 92 166 0453</a>

            <a className="hover:text-blue-700" href="mailto:umag@aquatic.com.hr">umag@aquatic.com.hr</a>
            <a className="hover:text-blue-700" href="mailto:aquatic.umag@gmail.com">aquatic.umag@gmail.com</a>
          </div>
        </div>
